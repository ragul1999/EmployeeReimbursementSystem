	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(empId==null && managerId==null ) {
			...
			if(!val.isAlreadyExistEmployee(employee)) {
				String invalidEmployee="<h3 style='color:red; text-align:center;'>Entered employee id doesn't exist</h3>";
				invalidEmployee+="<a href='http://localhost:8080/controller/manager_home.html?id="+managerId+"' style='display:inline-block;text-align:center'>Back to Home</a>";
				
				throw new EmployeeNotFoundException(invalidEmployee);
			}
